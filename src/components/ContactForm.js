...
const ContactForm = () => {
  return (
    <div id="contact" className="flex w-full justify-center items-center pb-12 pt-80 px-8 md:px-48 lg:px-6">
        ...
        <div className="flex flex-col space-y-8 justify-between">
          ...
          <div className="flex space-x-4 text-2xl">
            <a href="https://github.com/jbutlerola" target="_blank">
              <FontAwesomeIcon className="transform hover:scale-150 transition duration-500" icon={["fab", "github"]} />
            </a>
            <a href="https://www.linkedin.com/in/jack-butler-9a89a5224/" target="_blank">
              <FontAwesomeIcon className="transform hover:scale-150 transition duration-500" icon={["fab", "linkedin"]} />
            </a>
          </div>
        </div>
        {/* Form section*/}
